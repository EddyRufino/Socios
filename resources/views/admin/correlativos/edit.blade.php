...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <h4 class="font-weight-bold mt-3 pl-2 mb-4 pb-2"><a href="{{ route('fotochecks.index') }}" class="text-dark item text-decoration-none">Modifica Número Correlativo</a></h4>
