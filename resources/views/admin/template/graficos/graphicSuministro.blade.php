...
<head>
    ...
    <title>Gráficos Suministros</title>
</head>
...
<body>
    ...
    <img src="https://quickchart.io/chart?w=350&h=350&format=svg&c={
        ...
        },options:{title:{display:true,text:'Gráfico de Suministros - {{now()->format('Y')}}'}}}"
    />
    ...
    <img src="https://quickchart.io/chart?w=350&h=350&format=svg&c={
        ...
        },options:{title:{display:true,text:'Gráfico de Suministros'}}}"
    />
    ...
    <img src="https://quickchart.io/chart?w=350&h=350&format=svg&c={
        ...
        },options:{title:{display:true,text:'Gráfico Suministros Por Años'}}}"
    />
</body>
</html>