...
<body>
    ...
    <img src="https://quickchart.io/chart?w=350&h=350&format=svg&c={
        ...
        },options:{title:{display:true,text:'Gráfico de Socios - {{now()->format('Y')}}'}}}"
    />
    ...
    <img src="https://quickchart.io/chart?w=350&h=350&format=svg&c={
        ...
        },options:{title:{display:true,text:'Gráfico de Socios'}}}"
    />
    ...
    <img src="https://quickchart.io/chart?w=350&h=350&format=svg&c={
        ...
        },options:{title:{display:true,text:'Gráfico de Socios Por Años'}}}"
    />
</body>
</html>