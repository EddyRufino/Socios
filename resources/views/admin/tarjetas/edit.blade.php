...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <h4 class="font-weight-bold mt-3 pl-2 mb-4 pb-1"><a href="{{ route('tarjetas.index') }}" class="text-dark item text-decoration-none">Socios - Modificar Tarjeta Circulación</a></h4>
