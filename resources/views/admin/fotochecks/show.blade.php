    ...
    <div class="container py-4">
        <div class="col-sm d-flex justify-content-center flex-column align-items-center ">
            <li class="list-group-item border-0 m-0 pt-0 text-center bg-transparent">
                <strong><h5 class="font-weight-bold">FOTOCHECK</h5></strong>
        ...
        @admin
            <div class="d-flex justify-content-center align-items-center mb-3">
                <div class="form-check">
                    <form  method="POST" action="{{ route('check.fotocheck', $fotocheck) }}">
                        @csrf
                            <input class="form-check-input"
                                name="status"
                                type="checkbox"
                                value="1"
                                {{ old('status', $fotocheck->status) == 1 ? 'checked' : '' }}
                                id="defaultCheck1"
        ...
        <div class="d-flex justify-content-center flex-column align-items-center">
            ...
            <ul class='list-group col-md-3 mt-3'>
                ...
                <li class="list-group-item ">
                    <strong>Expedición:</strong> {{ $fotocheck->expedicion }}
                </li>
                <li class="list-group-item ">
