...
<body>
    ...
    @if ($nameAsociacion == 'juridica')
        <h4 class="center font-color">FOTOCHECKS - ENTIDADES PRIVADAS</h4>
    @elseif ($nameAsociacion == 'natural')
        <h4 class="center font-color">FOTOCHECKS - PERSONAS NATURALES</h4>
    @else
        <h4 class="center font-color">FOTOCHECKS
