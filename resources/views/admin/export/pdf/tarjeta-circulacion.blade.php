...
<body>
    ...
    @if ($nameAsociacion == 'juridica')
        <h4 class="center font-color">TARJETAS DE CIRCULACIÓN - ENTIDADES PRIVADAS</h4>
    @elseif ($nameAsociacion == 'natural')
        <h4 class="center font-color">TARJETAS DE CIRCULACIÓN - PERSONAS NATURALES</h4>
    @else
        <h4 class="center font-color">TARJETAS DE CIRCULACIÓN
