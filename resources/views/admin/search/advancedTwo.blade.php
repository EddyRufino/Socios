        ...
        <div>
            @canExport
                ...
                <span id="contenidoTarjeta" style="display: none">
                    <a href="{{ route('tarjeta.pdf', ['id' => request()->asociacione_id_two]) }}" class="ml-1 text-danger text-decoration-none tooltipw" target="_blank">
                        <span id="tooltipw" class="tooltiptext">Descarga Tarjetas Circulación</span>
                        @include('icons.pdf')
                    </a>
                    <a href="{{ route('tarjeta.excel', ['id' => request()->asociacione_id_two]) }}" class="ml-1 text-success text-decoration-none tooltipw">
                        <span id="tooltipw" class="tooltiptext">Descarga Tarjetas Circulación</span>
                        @include('icons.excel')
                    </a>
                </span>
                ...
                <span id="contenidoFotocheck" style="display: none">
                    <a href="{{ route('fotocheck.pdf', ['id' => request()->asociacione_id_two]) }}" class="ml-1 text-danger text-decoration-none tooltipw" target="_blank">
                        <span id="tooltipw" class="tooltiptext">Descarga Fotochecks</span>
                        @include('icons.pdf')
                    </a>
                    <a href="{{ route('fotocheck.excel', ['id' => request()->asociacione_id_two]) }}" class="ml-1 text-success text-decoration-none tooltipw">
                        <span id="tooltipw" class="tooltiptext">Descarga Fotochecks</span>
                        @include('icons.excel')
                    </a>
                </span>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    @canPrint
                                        @if ($socio->tarjetas()->exists() && $socio->tarjetas[0]->status == 0)
